    ...
    <div className="community-section-three-container">
      ...
      <div className="mt-10 w-full flex justify-center items-center relative">
        <Image
          ...
          width={500}
          height={500}
          className="community-sec-three-1 w-[260px] h-[500px] md:w-[300px] md:h-[600px] w-[] object-cover"
        />

        <div className="md:py-5 md:px-8 px-2 py-3 first-org absolute bg-[#FF981E] rounded-tl-4xl rounded-br-4xl lg:left-[21%] md:left-[14%] left-[18%] top-[20%] flex gap-2 items-center">
          <Image
        ...
        <div className=" md:py-4 md:px-8 px-3 py-4 second-org absolute bg-[#FF981E] rounded-4xl lg:right-[26%] md:right-[20%] right-[20%] top-[27%] flex flex-col gap-2 items-center">
          <Image
        ...
        <div className=" md:py-4 md:px-8 px-3 py-4 third-org absolute bg-[#FF981E] rounded-4xl lg:left-[26%] md:left-[21%] left-[20%] top-[45%] flex flex-col gap-2 items-center">
          <Image
