    ...
    <div className="community-hero-container">
      ...
      <div className="w-full md:mt-14 mt-8 flex flex-col md:flex-row justify-between">
        ...
        <div className="md:w-[50%] w-full flex flex-col text-white">
          {" "}
          <h1 className="lg:text-3xl md:text-2xl text-2xl font-bold animate-from-left">
            Protect Your <span className="p-2 bg-[#FF981E]">Health</span>{" "}
            Protect Your Future
          </h1>
          <p className="mt-4 animate-from-left delay-200">
            Vaccination the key to a safer community. We are here to make
            immunization safer, accessible simple and reliable
          </p>
          <div className="flex mt-8 gap-4 animate-from-left delay-400">
            <Link
              href=""
        ...
        <div className="md:w-[50%] w-full flex justify-center md:justify-end mt-8 md:mt-0  gap-2">
          ...
          <div className="w-auto flex flex-col items-end gap-2">
            {" "}
            <div className="w-[150px] h-[150px] relative rounded-2xl animate-from-left delay-200">
              <Image
            ...
            <Image
              ...
              width={500}
              height={500}
              className="community-hero-image w-[100px] h-[100px] rounded-2xl object-cover animate-from-left delay-400"
            />
          </div>{" "}
          <div className="w-auto flex flex-col items-end gap-2">
            <Image
              ...
              width={500}
              height={500}
              className="community-hero-image w-[100px] h-[100px] rounded-2xl object-cover animate-from-bottom delay-200"
            />
            <Image
              ...
              width={500}
              height={500}
              className="community-hero-image w-[100px] h-[100px] rounded-2xl object-cover animate-from-right delay-400"
            />
            <Image
          ...
          <div className="w-auto flex flex-col items-center justify-center gap-2 animate-from-right delay-200">
            <Image
...
export default withScrollAnimation(CommunityHero);
