  ...
  return (
    <div className="record-section-seven-container">
      <div className="w-full px-8 pt-8 bg-[#148782] flex flex-col md:flex-row justify-between gap-4">
        <div
          className="md:w-[50%] w-full flex flex-col animate-from-bottom"
        ...
        >
          ...
          <form className="w-full pb-8 mt-14 flex flex-col gap-8 text-white">
            <div
              className="flex gap-3 animate-from-bottom"
            ...
            <div
              className="flex w-full items-end justify-between gap-3 animate-from-bottom"
              style={{ animationDelay: "0.8s" }}
            >
              <label className="font-bold text-lg w-[18%]">Message:</label>
              <input className="w-[75%] md:w-[80%] border-b border-white focus:outline-none focus:ring-0" />
            </div>

            <button
              className="w-[140px] px-4 py-3 rounded-lg text-center font-bold text-white bg-[#FF981E] border border-gray-400 animate-from-bottom"
        ...
        <div
          className="md:w-[35%] w-full text-black px-4 py-8 flex flex-col justify-center bg-white rounded-t-4xl animate-from-bottom"
          style={{ animationDelay: "0.4s" }}
        >
          ...
          <div
            className="flex items-center gap-3 mt-8 animate-from-bottom"
            style={{ animationDelay: "0.6s" }}
          >
            <img
          ...
          <div
            className="flex items-center gap-3 mt-4 animate-from-bottom"
            style={{ animationDelay: "0.8s" }}
          >
            <img
...
export default withScrollAnimation(SectionSeven);
